...
import Input from '../pago/components/Input';
import InputCodigoPostal from "./components/InputCodigoPostal";
    ...
    return (
        ...
        <Navbar />
            <main className="relative pt-20 mx-5 md:w-screen">
                <h1 className="text-2xl text-center py-5 font-medium text-secondColor md:text-left md:px-10">Carrito de compra</h1>
